    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            ...
            <main>
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center g-0">
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="tpservices br-24 mb-30 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="tpservices br-24 mb-30 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                    <div class="tpservices__icon mb-25">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="tpservices br-24 mb-30  wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                                    <div class="tpservices__icon mb-25">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="tpservices br-24 mb-30 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">
                                    <div class="tpservices__icon mb-25">
                ...
                <div class="tp-fact-area tp-nblue-bg pt-130 pb-130" data-background="assets/img/fact/fact-pattern.png">
                    <div class="container">
                        <div class="row">
