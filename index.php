                ...
                <main>
                    ...
                    <section class="tp-hero-area tp-hero-space pt-210 pb-110 p-relative " style="background-image: url(assets/img/bg/hero-light-bg.jpg);">
                        <div class="tp-hero-shap">
                            <img class="tp-hero-3-shape-1 p-absolute wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.4s" src="assets/img/hero/hero-3-2.jpg" alt="">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="tp-hero-wrapper d-flex">
                                        <div class="tp-hero-img ml-25 mr-70 d-none d-lg-block wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-12 d-lg-none d-xl-block">
                                    <div class="tpservices__thumb br-20  wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                        <img src="assets/img/services/services-big.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-6 col-md-12">
                                    <div class="tp-about-thumb ml-60 mr-80 mb-40  p-relative text-center">
                                        <div class="tp-about-shape">
                                            <img class="tp-about-2-shape-1 p-absolute" src="assets/img/shape/home-3-acc-01.png" alt="">
                                            <img class="tp-about-2-shape-2 p-absolute" src="assets/img/shape/home-3-acc-02.png" alt="">
                                        </div>
                                ...
                                <div class="col-xl-5 col-lg-6 col-md-12">
                                    ...
                                    <div class="tp-about-btn mt-50 mb-40 wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.5s">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="tpprocess tpprocess-border mb-30 text-center pt-60 pb-60 pl-35 pr-35 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="tpprocess tpprocess-border mb-30 text-center pt-60 pb-60 pl-35 pr-35 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                        <div class="tpprocess__step mb-35">
                                            <span>Step (02)</span>
                                        </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="tpprocess tpprocess-border mb-30 text-center pt-60 pb-60 pl-35 pr-35 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                                        <div class="tpprocess__step mb-35">
                                            <span>Step (03)</span>
                                        </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="tpprocess tpprocess-border mb-30 text-center pt-60 pb-60 pl-35 pr-35 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">
                                        <div class="tpprocess__step mb-35">
                                            <span>Step (04)</span>
                                        </div>
                    ...
                    <section class="tp-showcase-area tp-nblue-bg pt-130 pb-130" data-background="assets/img/bg/project-bg-pattern.png">
                        <div class="container">
                            ...
                            <div class="row showcase-groid-item gx-xl-0 align-items-center">
                                <div class="col-xl-6 col-lg-6">
                                    <div class="tpshowcase__thumb br-20 w-img wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                        <img src="assets/img/project/project-01.jpg" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="row showcase-groid-item gx-xl-0 align-items-center flex-column-reverse flex-xl-row">   
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="tpshowcase__thumb br-20 w-img wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.4s">
                                        <img src="assets/img/project/project-02.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="row showcase-groid-item gx-xl-0 align-items-center">  
                                <div class="col-xl-6 col-lg-6">
                                    <div class="tpshowcase__thumb br-20 w-img wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.6s">
                                        <img src="assets/img/project/project-03.jpg" alt="">
                                    </div>
                                </div>
                                <div class="offset-xl-1 col-xl-5 col-lg-6">
                                    <div class="tpshowcase pl-10">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6 col-lg-5">
                                    <div class="tp-section-title-wrapper mb-50">
                                        <span class="tp-section-subtitle mb-10"><i class="sub-dot-color"></i> trusted clients</span>
                                        <h2 class="tp-section-title tp-upper mb-20 img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.4s">Popular company
                                            love us for our
                                            best service</h2>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="tpteam text-center mb-40 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                    <div class="tpteam__thumb p-relative br-15 mb-25">
                                        <a href="team-details.php"><img class="mb-10 z-2 p-relative" src="assets/img/team/team-tran-01.png" alt=""></a>
                                    ...
                                    <div class="tpteam__info">
                                        <h3 class="tpteam__title"><a href="team-details.php">Malisa Murray</a></h3>
                                        <span class="tpteam__subtitle">Photographer</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="tpteam text-center mb-40 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                    <div class="tpteam__thumb p-relative br-15 mb-25">
                                        <a href="team-details.php"><img class="mb-10 z-2 p-relative" src="assets/img/team/team-tran-02.png" alt=""></a>
                                        <div class="tpteam__thumb-bg" data-bg-color="#D6F0FF"></div>
                                        <div class="tpteam__thumb-bg-border"></div>
                                        <div class="tpteam__social-2">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                    ...
                                    <div class="tpteam__info">
                                        <h3 class="tpteam__title"><a href="team-details.php">Richard Bailey</a></h3>
                                        <span class="tpteam__subtitle">Project Manager</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="tpteam text-center mb-40 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                                    <div class="tpteam__thumb p-relative br-15 mb-25">
                                        <a href="team-details.php"><img class="mb-10 z-2 p-relative" src="assets/img/team/team-tran-03.png" alt=""></a>
                                        <div class="tpteam__thumb-bg" data-bg-color="#FFE4FB"></div>
                                        <div class="tpteam__thumb-bg-border"></div>
                                        <div class="tpteam__social-2">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                    ...
                                    <div class="tpteam__info">
                                        <h3 class="tpteam__title"><a href="team-details.php">Margare Colligan</a></h3>
                                        <span class="tpteam__subtitle">Graphic Designer</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="tpteam text-center mb-40 wow tpFadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">
                                    <div class="tpteam__thumb p-relative br-15 mb-25">
                                        <a href="team-details.php"><img class="mb-10 z-2 p-relative" src="assets/img/team/team-tran-04.png" alt=""></a>
                                        <div class="tpteam__thumb-bg" data-bg-color="#E2EAD7"></div>
                                        <div class="tpteam__thumb-bg-border"></div>
                                        <div class="tpteam__social-2">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                    ...
                                    <div class="tpteam__info">
                                        <h3 class="tpteam__title"><a href="team-details.php">Norris Belcher</a></h3>
                                ...
                                <div class="col-xl-8">
                                    <div class="tp-test-main-box">
                                        ...
                                        <div class="tp-testimonial-main-wrapper p-relative">
                                            ...
                                            <div class="tp-test-slider-arrow-2 tp-test-slider-arrow-3 d-flex align-items-center">
                                                <div class="tp-swiper-test-button-prev tp-swiper-test-2-button tp-rot-180"><i class="flaticon-right-arrow"></i></div>
                                                <span></span>
                    ...
                    <section class="tp-cta-bg-area pt-111 pb-110 p-relative tp-cta-overlay jarallax" data-background="assets/img/bg/cta-bg.jpg">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-8 text-center">
                                    <div class="tp-section-title-wrapper mb-50 position-relative z-2">
                                        <span class="tp-section-subtitle mb-10" data-color="#fff"><i class="sub-dot-color"></i> working process</span>
                                        <h2 class="tp-section-title tp-upper tp_title_anim mb-20" data-color="#fff">do you have any  <br>
